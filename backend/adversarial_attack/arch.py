from adversarial_attack.architech.vgg import VGG
from adversarial_attack.architech.cifar_10 import ResNet26
import torch
from adversarial_attack.dataset import get_num_classes
