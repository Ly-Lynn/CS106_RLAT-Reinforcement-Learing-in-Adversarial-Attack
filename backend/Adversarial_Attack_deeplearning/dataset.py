...
def get_dataset(dataset: str, split=None) -> Dataset:
    ...
    if dataset == "cifar10_splits":
        return Cifar_10_splts(r"C:\Users\thuyl\OneDrive - Trường ĐH CNTT - University of Information Technology\My documents\AI\ai-project\backend\Adversarial_Attack_deeplearning\Splits")
    
    else:
        return Cifar_10_splts(r"C:\Users\thuyl\OneDrive - Trường ĐH CNTT - University of Information Technology\My documents\AI\ai-project\backend\Adversarial_Attack_deeplearning\test_splits")
