...
from Adversarial_Attack_deeplearning import activation 
import torch
...
class ResNet26(nn.Module):
    def __init__(self, in_channels, out_channels, train_act='CosLU'):
        super().__init__()
...
# params = {
#     'in_channels': 3,  # Số kênh đầu vào của ảnh
#     'out_channels': 10,  # Số lượng lớp đầu ra
#     'activation': 'CosLU'  # Loại activation được sử dụng
# }


# # Khởi tạo mô hình ResNet26 với các tham số đã chỉ định
# model = ResNet26(params)
# model.load_state_dict(torch.load(r"D:\Reforinment-Learing-in-Advesararial-Attack-with-Image-Classification-Model\ep=90_lv=0.38.pth"))