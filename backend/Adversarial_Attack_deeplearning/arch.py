from Adversarial_Attack_deeplearning.architech.vgg import VGG
from Adversarial_Attack_deeplearning.architech.cifar_10 import ResNet26
import torch
from Adversarial_Attack_deeplearning.dataset import get_num_classes
